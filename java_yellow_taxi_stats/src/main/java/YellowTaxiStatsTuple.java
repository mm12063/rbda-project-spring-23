...
public class YellowTaxiStatsTuple implements Writable {
    ...
    public void setDistAvg(double dist_avg) {this.dist_avg = dist_avg;}
    public double getDistAvg() {return dist_avg;}
    public void setPassAvg(double pass_avg) {this.pass_avg = pass_avg;}
    public double getPassAvg() {return pass_avg;}
    public void setCostAvg(double cost_avg) {this.cost_avg = cost_avg;}
